import {AfterContentChecked, AfterViewChecked, AfterViewInit, Directive, ElementRef} from '@angular/core';
...
export class ScrollToBottomDirective {
    ...
    //   setTimeout(() => el.scrollTop = Math.max(0, el.scrollHeight - el.offsetHeight), 10);
    // }
